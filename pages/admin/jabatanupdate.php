    ...
    <div class="card">
        ...
        <div  class="card-body">
           ...
           <div class="form-group">
                ...
                <input type="number" class="form-control" value="<?php echo $row['gapok_jabatan']?>" name="gapok_jabatan" 
                onkeypress='return (event.charCode > 47 && event.charCode < 58) | event.charCode == 46'
               >
            </div> 
            <div class="form-group">
            <label for="tunjangan_jabatan">Tunjangan</label> 
            <input type="number" class="form-control" value="<?php echo $row['tunjangan_jabatan']?>" name="tunjangan_jabatan" 
            onkeypress='return (event.charCode > 47 && event.charCode < 58) | event.charCode == 46'
            >
        </div> 
        <div class="form-group">
        <label for="uang_makan_perhari">Uang Makan Perhari</label> 
        <input type="number" class="form-control" value="<?php echo $row['uang_makan_perhari']?>" name="uang_makan_perhari" 
        onkeypress='return (event.charCode > 47 && event.charCode < 58) || event.charCode == 46'
        >
    </div>
